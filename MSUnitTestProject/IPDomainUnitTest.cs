...
using IPDomainChecker;
using Newtonsoft.Json;
using System.Collections.Generic;
using IPDomainChecker.DataModels;
using IPDomainChecker.Controllers;
using Microsoft.AspNetCore.Mvc;

namespace MSUnitTestProject
{
    [TestClass]
    public class IPDomainUnitTest
    {

        IPDomainWorkersController _controller;
      
        public IPDomainUnitTest()
        {
            
            _controller = new IPDomainWorkersController();
        }
        [TestMethod]
        public void Get_WhenCalled_ReturnsInvalidRequest()
        {
            ...
            var expected = new BadRequestObjectResult(IPDomainChecker.Constants.ErrorConstants.InvalidRequest);
            Assert.AreEqual(
